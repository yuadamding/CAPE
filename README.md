...
`4.0.0.dev23` is engineering software; it is not a biological result and cannot
...
Dev23 retains the two immutable, failed T01 Hellinger candidates and the
passed T04 fixed-pool particle-engine qualification, then adds the completed
T02A raw-count and relative-mass noise calibration. T01 blocks the
...
[the detailed T07S record](docs/t07s-reaction-recovery.md), and
