...
MODELS = {
    ...
    "checkpoint-multinomial-decoder.v1.json": CheckpointMultinomialDecoderContract,
    "claim-registry.v1.json": ClaimRegistry,
    "g14-robustness-plan.v1.json": G14RobustnessPlan,
    "g14-multiplicity-contract.v1.json": G14MultiplicityContract,
    "g14-seal-contract.v1.json": G14SealContract,
